...
/// @brief helper of ft_join to assign the struct t_join_vars
/// @param t
/// @param hd
/// @param tl
/// @param sep
...
/// @param tl tail
/// @param sep the char to append at the end of the joint str. if sep is '\0', then no char is appended.
/// @return joined malloc-ed str. NULL if malloc fail or both hd and tl are NULL.
